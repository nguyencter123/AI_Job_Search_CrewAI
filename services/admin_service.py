...
"""
Facade cho Admin Panel — tích hợp code quản trị người dùng
từ nhánh phan-cao + thống kê hệ thống.
"""
...
class AdminFacade:
    ...
    def _format_user(user):
        return {
            "id": user.id,
            "email": user.email or user.phone_number or f"FB#{user.facebook_id}",
            "role": user.role,
